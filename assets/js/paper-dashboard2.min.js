...
(toggle_initialized = sidebar_mini_active = backgroundOrange = navbar_initialized = fixedTop = !(transparentDemo = transparent = !0)),
    ...
    $(document).ready(function () {
        ...
        0 != $(".tagsinput").length && $(".tagsinput").tagsinput(),
            ...
            0 != $(".selectpicker").length && $(".selectpicker").selectpicker({ iconBase: "nc-icon", tickIcon: "nc-check-2" }),
            ...
            0 != $(".navbar[color-on-scroll]").length && (paperDashboard.checkScrollForTransparentNavbar(), $(window).on("scroll", paperDashboard.checkScrollForTransparentNavbar)),
            $(".form-control")
                .on("focus", function () {
    ...
    $(document).on("click", ".navbar-toggle", function () {
        ($toggle = $(this)),
            1 == paperDashboard.misc.navbar_menu_visible
        ...
        (seq = seq2 = 0),
            0 == $(".full-screen-map").length &&
                ...
                $navbar.hasClass("bg-white") && 991 < $(window).width()
                    ...
                    : $navbar.hasClass("navbar-transparent") && $(window).width() < 991 && "false" != isExpanded && $navbar.addClass("bg-white").removeClass("navbar-transparent"));
    }),
    (paperDashboard = {
        ...
        startAnimationForLineChart: function (a) {
            a.on("draw", function (a) {
                "line" === a.type || "area" === a.type
                    ? a.element.animate({ d: { begin: 600, dur: 700, from: a.path.clone().scale(1, 0).translate(0, a.chartRect.height()).stringify(), to: a.path.clone().stringify(), easing: Chartist.Svg.Easing.easeOutQuint } })
                    : "point" === a.type && (seq++, a.element.animate({ opacity: { begin: seq * delays, dur: durations, from: 0, to: 1, easing: "ease" } }));
            }),
                (seq = 0);
        },
        startAnimationForBarChart: function (a) {
            a.on("draw", function (a) {
                "bar" === a.type && (seq2++, a.element.animate({ opacity: { begin: seq2 * delays2, dur: durations2, from: 0, to: 1, easing: "ease" } }));
            }),
                (seq2 = 0);
        },
        showSidebarMessage: function (a) {
            try {
                $.notify({ icon: "nc-icon nc-bell-55", message: a }, { type: "info", timer: 4e3, placement: { from: "top", align: "right" } });
            } catch (a) {
