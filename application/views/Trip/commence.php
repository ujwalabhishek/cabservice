                    ...
                    <div class="button-container">
                        <div class="row">
                            <div class="col-12 ml-auto">
                                <a href="<?php print site_url("Trip/commence_trip_by_driver/$trip_id/$action"); ?>" class="btn btn-primary ">Back</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-12">
                <div class="card ">
                    <div class="card-header ">
                        ...
                        <h5 class="card-title">Start/End Trip</h5>
                    </div>
                    <form method="post" action="<?php echo site_url("Trip/commence_trip_by_driver/{$trip_data['trip_id']}/$action"); ?>">
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter Starting Kms" <?php echo $action=="Start" ? '': 'readonly';?> name="start_km" value="<?php echo !empty($trip_data['start_km']) ? $trip_data['start_km']:'';?>" class="form-control textarea"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>End Kms</label>
                                        <input type="text" placeholder="Enter Ending Kms" <?php echo $action=="End" ? '': 'readonly';?> name="end_km"  value="<?php echo !empty($trip_data['end_km']) ? $trip_data['end_km']:'';?>" class="form-control textarea"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="hidden" name="rate_per_km" value="<?php echo $trip_data['rate_per_km']; ?>" />
                                        <input type="submit" value="<?php echo $action;?> Trip" class="btn"/>
                                    </div>
                                </div>
                            </div>                
                        </div>
                            ...
                            <div class="row text-left">
                                <div class="col-6 text-center">
                                    <a href="#">
                                        ...
                                        <h5 class="title"><?php echo $trip_data['passenger_name']; ?></h5>
                                    </a>
                                </div>
                                <div class="col-6 text-left" style="padding-top:50px">
                                    <p class="description email"><?php echo $trip_data['passenger_email']; ?></p>
                                    <p class="description phone"> <?php echo $trip_data['passenger_mobile']; ?></p>
                                    <p class="description rating">
